<template>
  ...
  <div v-if="loader" class="flex justify-center items-center">
    <div
      class="bg-bluegrey-900 w-40 h-10 flex items-center text-bluegrey-50 font-semibold p-4 rounded"
    >
      <svg
    ...
    <div class="p-4 flex flex-wrap">
      ...
      >
        <router-link
          ...
          v-model="value"
          class="px-4 py-2 my-2 bg-bluegrey-700 rounded-xl text-white hover:bg-lime-900"
          >{{ index }}</router-link
        >
      </div>
    </div>
